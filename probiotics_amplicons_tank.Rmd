...
sample_data(ps2_ra)$date<-factor(sample_data(ps2_ra)$date,levels=c("pre","1day","3days","7days","21days","28days"))
...
dis.treat$date<-factor(dis.treat$date,levels=c("pre","1day","3days","7days","21days","28days"))
